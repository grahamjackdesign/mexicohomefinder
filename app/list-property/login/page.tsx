...
const content = {
  en: {
    title: 'Welcome Back',
    subtitle: 'Sign in to manage your property listing(s)',
    email: 'Email Address',
    password: 'Password',
    signIn: 'Sign In',
  ...
  es: {
    title: 'Bienvenido',
    subtitle: 'Inicia sesión para gestionar tu(s) propiedad(es)',
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:border-transparent transition-colors"
                style={{ '--tw-ring-color': '#C1714F' } as React.CSSProperties}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:border-transparent transition-colors"
              />
              <button
                type="button"
